...
class IoContract(Generic[TermList_t]):
    ...
    def compose(self: IoContract_t, other: IoContract_t, vars_to_keep: Any = None,simplify: bool = True, diagnostics=False, to_diagnose = None, look_here = None) -> IoContract_t:  # noqa: WPS231
        # global return_dict
...
>>>>>>> 762538dd4ebef62311943e5b0f23e28145249983
